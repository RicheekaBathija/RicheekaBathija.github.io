...
{
$qm="select profileid,starttime,startdate,passenger1,passenger2,passenger3 from history where profileid='$valuex'";
...
$value2=htmlspecialchars($values2[5]);
    print "<th>".$value2."</th>";
$value2=htmlspecialchars($values2[7]);
    print "<th>".$value2."</th>";
$value2=htmlspecialchars($values2[9]);
    print "<th>".$value2."</th>";
$value2=htmlspecialchars($values2[11]);
    print "<th>".$value2."</th>";
...
$qu1="select * from profile where profileid ='$x'";
